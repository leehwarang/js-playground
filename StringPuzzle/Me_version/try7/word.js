var random_list = 'apple,michelle,frank,programmer,helloworld,rurulee,newyork,youonlyliveonce,sanfransico,november'.split(',');
...
var shuffle = function(){ 
    ...
    var n = Math.floor(Math.random() * (game.word_list.length -1)) + 1;
